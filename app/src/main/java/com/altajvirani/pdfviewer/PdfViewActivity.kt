...
import com.altajvirani.pdfviewer.utils.FileUtils
...
class PdfViewActivity : AppCompatActivity() {
    ...
    private fun selectPdfFromStorage() {
        ...
        startActivityForResult(
            Intent.createChooser(browseStorage, "Please select PDF from storage."), PDF_SELECTION_CODE
        )
    }
        ...
        PRDownloader.download(
            ...
            .start(object : OnDownloadListener {
                override fun onDownloadComplete() {
                    Toast.makeText(this@PdfViewActivity, "PDF Downloaded.", Toast.LENGTH_LONG)
                        .show()
                ...
                override fun onError(error: Error?) {
                    Toast.makeText(
                        this@PdfViewActivity,
                        "Error in downloading the PDF: $error",
                        Toast.LENGTH_LONG
                    )
                        .show()
                }
